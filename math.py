...
def main():
    ...
    print("its a math game!!")
    print("You have 30 seconds to answercorrectly.")
    print("You start with 3 lives. each wrong ans= 1 lifegone.")
    ...
    while True:
        ...
        if answer == correct_answer:
            ...
            print(f"wrongg! its {correct_answer}.\n")
            streak = 0
            lives -= 1
    ...
    print(f"UR STREAK WAS: {max_streak}")
